        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">Registrate</p>
                    <h2 class="fw-bold">Registra tu información</h2>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form action="php scripts/login.php" method="post">
                                ...
                                <div class="mb-3"><input class="form-control" type="text" name="Apellido" placeholder="Apellido"></div>
                                ...
                                <p class="text-muted">¿No tienes una cuenta?&nbsp;<a href="login.php">Inicia sesion</a>.<br></p>
                            </form>
                        </div>
                    </div>
                </div>
